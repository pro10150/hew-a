...
class ActionsToolbar extends StatelessWidget {
  ...
  Future<List<LikeModel>>? likes;
  Future<List<CommentModel>>? commentModels;
  Future<List<UserModel>>? userModels;
  Future<List<FollowModel>>? followModels;
  UserModel userModel;
  Future<String>? url;

  getFollow() {
    var objects = FollowHelper().getFollower(menuRecipeModel.recipeUid!);
    followModels = objects;
  }
  ...
  Widget _getPlusIcon() {
    return FutureBuilder<List<FollowModel>>(
        future: followModels,
                            ...
                            onTap: () {
                              ...
                              if (isLiked == false) {
                                ...
                                setState(() {
                                  isLiked = false;
                                  snapshot.data!
                                      .removeAt(snapshot.data!.length - 1);
                                });
                              }
                            },
